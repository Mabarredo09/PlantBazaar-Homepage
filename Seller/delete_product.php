...
$sql = "INSERT INTO product_archive (plantid, postedBy, postPlantName, price, plantcategories, plantSize, plantColor, location, img1, img2, img3) VALUES ('$listingData[plantid]', '$email', '$listingData[plantname]', '$listingData[price]', '$listingData[plantcategories]', '$listingData[plantSize]', '$listingData[plantColor]', '$listingData[location]', '$listingData[img1]', '$listingData[img2]', '$listingData[img3]')";
$result = mysqli_query($conn, $sql);
